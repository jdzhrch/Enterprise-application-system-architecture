 ...
 * 
 */
@WebServiceClient(name = "WarehouseService", targetNamespace = "http://DefaultNamespace", wsdlLocation = "http://localhost:8080/WarehouseService/services/Warehouse?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WAREHOUSESERVICE_QNAME = new QName("http://DefaultNamespace", "WarehouseService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WarehouseService/services/Warehouse?wsdl");
     ...
     *     returns Warehouse
     */
    @WebEndpoint(name = "Warehouse")
    public Warehouse getWarehouse() {
        return super.getPort(new QName("http://DefaultNamespace", "Warehouse"), Warehouse.class);
    }
     ...
     */
    @WebEndpoint(name = "Warehouse")
    public Warehouse getWarehouse(WebServiceFeature... features) {
        return super.getPort(new QName("http://DefaultNamespace", "Warehouse"), Warehouse.class, features);
    }
