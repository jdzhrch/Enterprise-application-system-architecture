...
public class BookCategoryTest
{
   ...
   {
      System.setProperty("java.security.policy", "E:/GitHub/proj/Enterprise application system architecture/PermissionTest/PermissionTest.policy");      
...
class WordCheckTextArea extends JTextArea
{
   ...
   {
      BookCategoryPermission p = new BookCategoryPermission(text, "access");
