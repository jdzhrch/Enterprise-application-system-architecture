			...
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="allOrderPro"><i class="fa fa-reorder fa-fw"></i>
							Orders</a></li>
					<li><a href="allOrderitemPro"><i class="fa fa-table fa-fw"></i>
							Orderitems</a></li>
						...
						<div class="col-lg-12">
							<form role="form">
								<div class="form-group">
									<label>Title</label> <input onblur="checkInfo()"
										id="title_book" class="form-control" name="title">
								</div>
								<div class="form-group">
									<label>Author</label> <input onblur="checkInfo()"
										class="form-control" name="author">
								</div>
								<div class="form-group">
									<label>Price</label> <input onblur="checkInfo()"
										class="form-control" type="number" step="0.01" name="price">
								</div>
								<div class="form-group">
									<label>Publisher</label> <input onblur="checkInfo()"
										class="form-control" name="publisher">
								</div>
								<div class="form-group">
									<label>Date</label> <input onblur="checkInfo()"
										class="form-control" type="date" name="date">
								</div>
								<div class="form-group" hidden="true">
									<label>Image</label> <input onblur="checkInfo()"
										class="form-control" name="image">
								</div>
								<div class="form-group">
									<label>stock</label> <input onblur="checkInfo()"
										class="form-control" type="number" step="1" name="stock">
								</div>
								<div class="form-group">
									<label>category</label> <select onblur="checkInfo()"
										class="form-control" id="bookcategory">
							...
							<form id="form_picture" method="post" action="savePictureBookPro"
								enctype="multipart/form-data">
								<div class="form-group" hidden="true">
									<label>Title</label> <input id="title_picture"
										class="form-control" name="title">
								</div>
								<div class="form-group">
									<label>Picture</label> <input id="imageFile"
										onblur="checkInfo()" type="file" class="form-control"
										name="imageFile">
								</div>
							</form>
						</div>
