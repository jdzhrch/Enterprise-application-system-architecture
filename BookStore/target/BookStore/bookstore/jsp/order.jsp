									...
									<tbody>
										<%
											for (int i = 0; i < orderList.size(); i++) {
												...
												RmiOrder rmiOrder = new RmiOrder(order.getUserid(),order.getDate(),order.getEnddate(),order.getAddress(),order.getPhone());
										%>
										<tr>
											<td><%=order.getId()%></td>
											...
											<td>
												...
												<button class="btn btn-default" type="button" onclick="$(modal_ship_result).modal('show');">
													ship
												</button>
											</td>	
										</tr>
										...
										<div class="modal fade" id="modal_ship_result" tabindex="-1" role="dialog"
											...
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-body">
														<div class="row">
															<div class="col-lg-12">
																<p><%=rmiClient.runShipOrder(rmiOrder) %></p>
															</div>
														</div>
													</div>
													<div class="modal-footer">
														<button type="button" class="btn btn-primary" onclick="$(modal_ship_result).modal('hide');" >Ok</button>
													</div>
												</div>
											</div>
										</div>
